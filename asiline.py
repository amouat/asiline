...
def asi(fname, type="htmlbook"):
    ...
    shell_indicators = set(["root@3baff51314d6:/data# ", "$ ",
                            ...
                            "core@core-01 ~ $ ", "core@core-02 ~ $ ", "core@core-03 ~ $ ",
    ...
    with open(fname) as f:
        for line in f:
            ...
            if in_code:
                ...
                if have_ind:
                    if line[-2:-1] == "\\":
                        print(have_ind, in_open_tag,
                              line[len(have_ind):-1], anno(), sep='')
                        in_cont = True
                        continue
                    else:
                        print(have_ind, in_open_tag, line[len(have_ind):-1],
                              in_close_tag, anno(), sep='')
                        continue
                ...
                if line[0] == "<" and line[2] == ">":
                    if line[1] in annos:
                        ...
                        if an == 1:
                            print('pass:[<dl class="calloutlist">]')
